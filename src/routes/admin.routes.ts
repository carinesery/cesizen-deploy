...
router.get("/user/:id", authMiddleware, roleMiddleware(UserRoleEnum.ADMIN), validate(getUserParamsSchema, "params"), getUserController);
...
router.patch("/user/:id", authMiddleware, roleMiddleware(UserRoleEnum.ADMIN), validate(adminUpdateUserParamsSchema, "params"), validate(adminUpdateUserBodySchema, "body"), updateUserController);
